...
@section('content')
  ...
  <section class="links-block">
      ...
      <ul class="links-block__list">
          <li class="links-block__item links-block__item_active"><a class="links-block__link" href="{{ route('login') }}">{{ __('app.pages.auth.title') }}</a></li>
          <li class="links-block__item"><a class="links-block__link" href="{{ route('register') }}">{{ __('app.pages.registration.title') }}</a></li>
      </ul>
