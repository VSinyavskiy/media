        ...
        'NestedInfo' => [
            '*' => [
                'title' => [
                    ...
                    'max'      => 'Количество символов в поле Заголовок не может превышать :max.',
                ],
                'description' => [
                    'required' => 'Поле Описание обязательно для заполнения.',
                    'max'      => 'Количество символов в поле Описание не может превышать :max.',
                ],
            ],
        ],
        'Slides' => [
            '*' => [
                'image' => [
                    ...
                    'max'      => 'Размер файла в поле Изображение не может быть более :max Килобайт(а).',
                    'image'    => 'Поле Изображение должно быть изображением.',
                ],
            ],
        ],
        'birth_date' => [
            'before' => 'Минимальный возраст 18 лет',
            'after'  => 'Максимальный возраст 70 лет',
        ],
        'passport_issued_at' => [
            'before' => 'Неправильная дата',
        ],
        'card_issued_at' => [
            'before' => 'Неправильная дата',
        ],
        'card_expires_at' => [
            'before' => 'Дата не должна превышать 10 лет от даты выдачи',
            'after' => 'Срок действия паспорта истек',
        ],
    ],
    /*
    |--------------------------------------------------------------------------
