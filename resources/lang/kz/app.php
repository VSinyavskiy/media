...
return [
    ...
    'modals' => [
        ...
        'registration_confirm_email' => [
            ...
            'description' => 'Тіркелуіңе аз қалды! Енді e-mail-ды растасаң болды; біз саған хат жібердік.<br/>Поштаңды және спамды тексер.',
        ],
    ...
    'emails' => [
        ...
        'user_register_notification' => [
            ...
            'greeting' => 'Сәлеметсіз бе!',
            'first_line' => 'Тіркелуден сәтті өту үшін төмендегі сілтеме бойынша өт!',
            'button' => 'Қосылу!',
        ],
    ],
