...
return [
    ...
    'pages' => [
        ...
        'winners' => [
            ...
            'button' => 'Іздеу',
            'more' => 'Көбірек көрсету',
            'not_found' => 'Көрсетілген телефон нөмірі бойынша жеңімпаздар табылмады. Іздеу шарттарын өзгертіңіз.',
        ],
    ...
    'presents' => [
        'certificate_2000' => 'Сыйлық сертификаты 2 000 теңге',
        'certificate_10000' => 'Сыйлық сертификаты 10 000 теңге',
        'certificate_20000' => 'Сыйлық сертификаты 20 000 теңге',
    ],

    'shares' => [
        'title' => 'LAY’S ДОНЕР',
        'description' => 'Достарыңды  шақыр! Жүлделер ұтып ал!',
    ],
];
